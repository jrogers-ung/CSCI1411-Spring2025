...
# For example, you should see PS C:\Users\administrator\CSCI1411-Spring2025\Assignments\Assignment3>         #       
# One way is to run "cd C:\Users\administrator\CSCI1411-Spring2025\Assignments\Assignment3" before starting  #
# the assignment                                                                                           #
